        ...
        <section class="mb-12">
            <div class="flex justify-center">
                <div class="inline-flex rounded-full border-2 border-[#1B2B28] p-1">
                    <button
                        id="food-tab"
                        class="px-8 py-3 rounded-full text-sm font-medium transition-all duration-300 {{ $category == 'makanan' ? 'bg-[#1B2B28] text-white' : 'text-[#333333]' }}"
                    ...
                    <button
                        id="drink-tab"
                        class="px-8 py-3 rounded-full text-sm font-medium transition-all duration-300 {{ $category == 'minuman' ? 'bg-[#1B2B28] text-white' : 'text-[#333333]' }}"
